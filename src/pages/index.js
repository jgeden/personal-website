      ...
      <div className="aboutme">
        <div className="container">
          ...
          <div className="content">
            ...
            <p>I am currently a software engineer intern at <a href="https://www.lbl.gov" target="_blank" rel="noreferrer">Lawrence Berkeley National Lab</a> <span role="img" aria-label="national lab emojis">🌇🇺🇸🧪</span>and <a href="https://www.nersc.gov" target="_blank" rel="noreferrer">NERSC</a>, where I am developing software in Javascript and Python to extend JupyterLab <span role="img" aria-label="javascript and python emojis">☕️🐍🪐</span>. My work focuses on making the supercomputers at Berkeley more accessible and user friendly through Jupyter. Check out my projects page to see some of these extensions!</p>
