        ...
        <ReactFullpage.Wrapper>
          ...
          <div className="section" id="s2">
            <div className="content">
              ...
              <p>I was born and raised in South Carolina <span className="emoji" role="img" aria-label="SC emojis">🌙🌴</span> and am now living in San Francisco <span className="emoji" role="img" aria-label="Berlin emojis">🚉🌉</span>. I am a third-year student at Duke University, where I am studying Computer Science, Linguistics, & German. Go Blue Devils <span className="emoji" role="img" aria-label="blue devil emojis">🔵😈</span>!</p>
